...
@pytest.mark.parametrize("test_heap,test_node", [([1, 2, 4, 6, 10], 1)])
...
@pytest.mark.parametrize("test_heap,test_node", [([1, 2, 4, 6, 10], 1), ([1, 2, 3], 0)])
...
@pytest.mark.parametrize("test_input", [[8, 1, 2, 4], [1, 2, 5, 3], [5]])
...
@pytest.mark.parametrize(
    "test_input", [[1, 2, 54, 5, 2, -1, 21, 3], [2], [-1], [5, 2, -1]]
)
